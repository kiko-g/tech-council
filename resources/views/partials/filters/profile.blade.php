<nav class="navbar-dark bg-petrol mb-3 rounded p-2">
  <div class="btn-toolbar justify-content-between px-1">
    ...
    <div class="btn-group" role="group" aria-label="Radio toggle button group">
      <input type="radio" class="btn-check" name="radio button" id="radio-saved" checked>
      ...
      <input type="radio" class="btn-check" name="radio button" id="radio-myquestions">
      <label class="btn blue-alt" for="radio-myquestions">
        <i class="fas fa-question-circle fa-sm text-teal-200"></i>&nbsp;My Questions
      </label>

      <input type="radio" class="btn-check" name="radio button" id="radio-myanswers">
