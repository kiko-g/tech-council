    ...
    <div class="row p-0">
      <div class="footer-section rounded-left col-lg-4 col-lg col-12 col p-4">
        ...
        <ul class="footer-ul">
          ...
          <br>
          <li class="border-top-medium text-end pt-1"> Designed using Bootstrap5 by <a href="#">LBAW 2132</a> &copy;
          </li>
        </ul>
      </div>
      ...
      <div class="footer-section rounded-right col-lg-4 col-lg col-12 col p-4">
        ...
        <ul class="footer-ul">
          <li><i class="fa fa-github"></i>&nbsp; <a target="_blank" href="https://github.com/ffriande">Francisco Friande
            </a></li>
          <li><i class="fa fa-github"></i>&nbsp; <a target="_blank" href="https://github.com/kiko-g">Francisco Gonçalves
            </a></li>
          <li><i class="fa fa-github"></i>&nbsp; <a target="_blank" href="https://github.com/TsarkFC">João Romão </a>
          </li>
          <li><i class="fa fa-github"></i>&nbsp; <a target="_blank" href="https://github.com/migueldelpinto">Miguel
              Pinto </a></li>
        </ul>
      </div>
      <!-- DIV 1 -->
