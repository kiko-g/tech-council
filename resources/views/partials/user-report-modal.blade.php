<div class="modal fade user-report-modal-{{ $user_id }} text-start" id="user-report-modal-{{ $user_id }}" tabindex="-1">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="user-report-form-{{ $user_id }}" class="" action="
          ...
          <div class="container px-3 py-2">
            <div class="col">
              <div class="form-check col">
                <input class="form-check-input report" type="radio" name="user-report-radio-{{ $user_id }}"
                  id="ur-radio-{{ $user_id }}-1">
          ...
          <div class="mt-3">
            <textarea class="form-control shadow-sm border border-2 bg-light mt-3"
              id="user-report-description-{{ $user_id }}" rows="3"
      ...
      <div class="modal-footer">
        <button id="submit-user-report-button-{{ $user_id }}" onclick="submitUserReport(this.id)" type="button" 
          class="submit-user-report-button btn blue">Submit</button>
      </div>
    </div>
  </div>
</div>
