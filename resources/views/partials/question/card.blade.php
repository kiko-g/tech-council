...
<div class="card mb-5 p-2-0 border-0 rounded">
    ...
    <div class="card-body">
        <article class="row row-cols-2 mb-1">
            ...
            <div class="col-9 col-sm-10 col-md-11 col-lg-11 flex-wrap pe-0">
                <div id="question" class="mb-1">
                    ...
                    However, I ran into a bug, changed one of them into <code>.equals()</code> instead, and it fixed the
                    bug.


                    <button class="btn btn-outline-info dark border-0 py-0 px-1" type="button"
                        onclick="toogleText(this)" data-bs-toggle="collapse" data-bs-target="#collapseQuestionText2"
                        aria-expanded="false" aria-controls="collapseQuestionText2">
                        <i class="fas fa-ellipsis-h"></i>
                    </button>

                    <div class="collapse mt-2" id="collapseQuestionText2">
                        However, I ran into a bug, changed one of them into <code>.equals()</code> instead, and it fixed
                        the bug.
                ...
                <div class="row row-cols-2 mb-1">
                    <div id="interact" class="col-md flex-wrap">
                        <div class="btn-group mt-1 rounded">
                            <a class="upvote-button my-btn-pad2 btn btn-outline-success bookmark"
                                id="upvote-button-<ID>" onclick="toggleStar(this)" href="#">
        ...
        <?php if ($comments != null) {
        buildCommentSection($comments, 1);
        } ?>
    </div>
        ...
        <article class="row row-cols-2 mb-2">
            ...
            <div class="col-9 col-sm-10 col-md-11 col-lg-11 flex-wrap pe-0">
                <div id="question" class="mb-1">
                    ...
                    <button class="btn btn-outline-info dark border-0 py-0 px-1" type="button"
                        onclick="toogleText(this)" data-bs-toggle="collapse" data-bs-target="#collapseQuestionText"
                        aria-expanded="false" aria-controls="collapseQuestionText">
                        <i class="fas fa-ellipsis-h"></i>
                    </button>

                    <div class="collapse mt-2" id="collapseQuestionText">
                        Considering how much I love working with jQuery and JavaScript in general, I can't help but
                        wonder how to decide when to use Node.js.
                        ...
                        information. <code>Node.js</code>
                        <ul>
                            <li>is a command-line tool that can be run as a regular web server and lets one run
                            ...
                            <li>is event-based so all the wonderful <code>Ajax</code>-like stuff can be done on the
                                server side</li>
