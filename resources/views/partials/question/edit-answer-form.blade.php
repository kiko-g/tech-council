...
<div class="col-9 col-sm-10 col-md-11 col-lg-11 flex-wrap pe-0 collapse answer-collapse-{{ $answer->content_id }}">
    <form class="answer-collapse-{{ $answer->content_id }} container ps-0 answer-edit-form" id="answer-edit-form-{{ $answer->content_id }}" method="post">
        @method('PUT')
        @csrf
        <div class="row row-cols-2">
            ...
            <div class="col-1 p-0 m-0 collapse answer-control answer-collapse-{{ $answer->content_id }}" id="answer-control-{{ $answer->content_id }}">
                <div class="btn-group float-end">
                    <button class="btn p-0" type="submit" data-bs-toggle="collapse" data-bs-target=".answer-collapse-{{ $answer->content_id }}" aria-expanded="true" aria-controls="answer-content-{{ $answer->content_id }} answer-control-{{ $answer->content_id }}">
