...
-- USER TABLE
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('francisco.friande@fe.up.pt','FFiambre','$2b$12$U3ImTCPbiKoRUxuM9qsEFOG2jKD6tTEOpt7sAl24xutrQwfkBqP2O','3/14/2021','2000','My name is Francisco Friande, I am 23 years old and I live in Bắc Giang, Vietnam. I''m interested in Photos and Videos','False','True',2);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('francisco.jpg@fe.up.pt','KikoDeLasAlves','$2b$12$mAWegOEC3Pk644UeRLekHOiZ5spuON6CXivXmv6q1N0WX3v9pavtu','3/13/2021','2000','My name is Francisco Gonçalves, I am 21 years old and I live in Porto, Portugal. I''m interested in Android, Keras, Data and JavaScript','False','True',3);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('joao.romao@fe.up.pt','jdiogueiro','$2b$12$aXC3TEYEhoO/J4sc0pASMOE6dDsmaGhDpAdq5fUUf5gN5yitAWJ1e','11/23/2020','2000','My name is João Romão, I am 20 years old and I live in Raghunathpur, India. I''m interested in PyCharm, Eclipse and Mac','False','True',4);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('miguel.pinto@fe.up.pt','mpintarolas','$2b$12$Oyu3P4Hb.PbK8hKwHlS1Ge8rqXnGwl3Kwkc/y35.W0bhjnU4sjjcS','10/27/2020','2000','My name is Miguel Pinto, I am 22 years old and I live in Moscow, Russia. I''m interested in Keyboards, Linux and Mac','False','True',5);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('cmoore4@amazonaws.com','jlopes4ever','$2b$12$ltq/g0Ld.kfCto/4Mu7J5eAN2f6NQNrwHldILCfzEgtUUc0Ph3O/y','5/27/2020','45','My name is Cross Moore, I am 31 years old and I live in Kundiān, Pakistan. I''m interested in CMD, Powershell, Linux and Angular','False','False',6);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('lwooder5@msu.edu','laz_woody','$2b$12$8kQx47tu7a5BtiVO./Haau.WgNTxxDPDJIRIkFZlU5qbkFXADYGJO','12/23/2020','63','My name is Lazarus Wooder, I am 25 years old and I live in Paradise, Trinidad and Tobago. I''m interested in XML, Excel, Security and Xiamoi','False','False',7);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('lbrashier6@eepurl.com','LuceB3','$2b$12$2zcey8JClzQWY6qfD6z3juVPLCZ7BczJFR1WEBvg2aCZhEjaDn5lS','2021-09-02 00:00:00','182','My name is Luce Brashier, I am 18 years old and I live in Nagqu, China. I''m interested in Photo Editing, DOM, CMD and Regex','False','False',8);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('bfolshom7@squarespace.com','john_cleeeese','$2b$12$7Qb8SniLKbf6Ym4aC4cnUe6kGSp7IzbmP41DTrGb.EtFJYAIHZCKK','2020-05-07 00:00:00','1600','My name is Bess Folshom, I am 57 years old and I live in Dobryanka, Russia. I''m interested in Eclipse and HP','True','True',9);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('srugg8@bigcartel.com','ShaylynnR','$2b$12$epVh5ta9YNMEuUdbrt.4MOeXt0koeVz.aa.mW7fgya5MvPBa304de','2020-12-05 00:00:00','11','My name is Shaylynn Rugg, I am 32 years old and I live in Västervik, Sweden. I''m interested in XML and Cloud','False','False',10);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('byates9@blogs.com','LilYatty','$2b$12$52UIfQfi1pwE7jJ9EzfKcur2WMu5.ZXVvkLqpl62UMlD6Z5OdV1XG','11/30/2020','0','My name is Babita Yates, I am 25 years old and I live in Chilakalūrupet, India. I''m interested in Web Applications, Algorithms, Circle CI and PlayStation','True','False',11);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('fcastagnea@berkeley.edu','floribella69','$2b$12$Sdy0OIopbnFfMCMffTrMbe6CGyZw7wo8y4WTnugaL//6kUhnWEaVm','11/28/2020','1700','My name is Florella Castagne, I am 34 years old and I live in Hanawa, Japan. I''m interested in Keyboard and Samsung','False','True',12);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('bclaringboldb@utexas.edu','bugsboony12','$2b$12$u/MLqaW/2aKnC7kDaIE9e.JWgna8qQSpomz7ToI13pXEoFAgzGVue','9/23/2020','80','My name is Boony Claringbold, I am 57 years old and I live in ’Aïn el Turk, Algeria. I''m interested in Google Drive and PHP','False','False',13);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('hbetancourtc@altervista.org','hakeeeeeeem123','$2b$12$3F26RaXQCPMnVv112R6Sv.41nNAH36KWgrWiftM3SnX3NUie3YRTe','2020-10-08 00:00:00','1930','My name is Hakeem Betancourt, I am 43 years old and I live in Forlì, Italy. I''m interested in Mouse','False','True',14);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('sfitterd@instagram.com','the_office_lover','$2b$12$Yt9wGFlpeqwZQHav6CSzoe7m6g8Nf4F0LTcgEsmMBgNHDba8iDGOS','7/17/2020','22','My name is Stanleigh Fitter, I am 47 years old and I live in Oria, Spain. I''m interested in PHP','False','False',15);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('alikelye@goo.gl','fireToTheRain','$2b$12$2S3V87rU0p8xyVEw0I9rmOj1AgwP0pYg6oK.UNQv.530nNsSQQn1e','2021-07-02 00:00:00','1860','My name is Adelbert Likely, I am 52 years old and I live in Harburg, Germany. I''m interested in Web Scraping, Apache and XML','False','True',16);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('oapperleyf@msu.edu','olive_oil','$2b$12$wUzsQlH2VFgAIYEFiTgvC.5j6I7UIhp9r91yo3ugRpqfrDAK7zTp6','2020-01-08 00:00:00','4','My name is Olivier Apperley, I am 59 years old and I live in Kōnosu, Japan. I''m interested in Cloud and SQL','False','False',17);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('icasierg@cnbc.com','CaseyNeistat','$2b$12$MX3wZ/tU8ubWfQMk0SDb9ukte1GXgKEXJaRvAbtyww76fl8q3Pl4.','6/26/2020','2100','My name is Inez Casier, I am 21 years old and I live in Burg Unter-Falkenstein, Germany. I''m interested in Eclipse','True','True',18);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('cpatshullh@sciencedaily.com','Patcholi','$2b$12$mwNDD5ika4H39whBQs7vEulhtI3V3lVEWzmVWShGg11qc7TCDjwUC','2021-12-03 00:00:00','31','My name is Chrysa Patshull, I am 19 years old and I live in Nabatîyé et Tahta, Lebanon. I''m interested in Oracle and C#','False','False',19);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('cgasperoi@ehow.com','GassyCassy','$2b$12$.9MXJ5B4NLPv4Z.blGwqU.McU9sF2vU0Fi9QsOn16udO2PLMin8GS','2021-12-03 00:00:00','31','My name is Casandra Gaspero, I am 44 years old and I live in Shāhpura, India. I''m interested in Regex','False','False',20);
INSERT INTO "user"(email,"name","password",join_date,reputation,bio,banned,expert,profile_photo) VALUES ('paulocarvalho6@youtu.be','paulinho33','$2b$12$qsDKG6Qdll4GCJFSzPuGFO2Y1VPKK5/dQXGW81a7KQPzcnUGbTria','4/23/2020','1953','My name is Paulo Carvalho, I am 34 years old and I live in Funchal, Portugal. I''m interested in Data Science and PyCharm','False','True',21);
...
<pre><code class="lang-js"><span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">printFiles</span>() </span>{
...
<p>If you want to read the files in parallel, you cannot use <code>forEach</code> indeed. Each of the <code>async</code> callback function calls does return a promise, but you&#39;re throwing them away instead of awaiting them. Just use map instead, and you can await the array of promises that you&#39;ll get with <code>Promise.all</code>:</p>
<pre><code class="lang-js"><span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">printFiles</span>() </span>{ 
  <span class="hljs-keyword">const</span> files = <span class="hljs-keyword">await</span> getFilePaths(); 
  <span class="hljs-keyword">await</span> <span class="hljs-built_in">Promise</span>.all(files.map(<span class="hljs-keyword">async</span> (file) =&gt; {
     <span class="hljs-keyword">const</span> contents = <span class="hljs-keyword">await</span> fs.readFile(file,<span class="hljs-string">"utf8"</span>);
     <span class="hljs-built_in">console</span>.log(contents);
  })); 
}
