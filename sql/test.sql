...
INSERT INTO user_vote_question ("user_id", question_id, vote) VALUES (1, 50, 1);
INSERT INTO user_vote_question ("user_id", question_id, vote) VALUES (2, 50, 1);
INSERT INTO user_vote_answer ("user_id", answer_id, vote) VALUES (1, 51, -1);
...
UPDATE user_vote_question SET vote = -1 WHERE "user_id" = 1;
UPDATE user_vote_answer SET vote = 1 WHERE "user_id" = 1;
...
INSERT INTO report (id, "description", reporter_id) VALUES (34, 'valid report', 2);
INSERT INTO user_report (report_id, "user_id") VALUES (34, 1);
...
-- no moderator reports
INSERT INTO report (id, "description", reporter_id) VALUES (37, 'moderator report', 1);
INSERT INTO user_report (report_id, "user_id") VALUES (37, 2); --moderators cannot be reported thrown

-- no moderator content reports
INSERT INTO content (id, main, author_id) VALUES (57, 'question', 2);
INSERT INTO question (content_id, title) VALUES (57, 'title');
INSERT INTO report (id, "description", reporter_id) VALUES (38, 'not self report', 2);
INSERT INTO content_report (report_id, content_id) VALUES (38, 57); --moderators' content cannot be reported thrown
...
UPDATE answer SET is_best_answer = TRUE WHERE content_id = 52;
SELECT * FROM "notification"; -- should not create
SELECT * FROM "user"; --user 1 should have the same reputation
UPDATE answer SET is_best_answer = TRUE WHERE content_id = 51;
SELECT * FROM "notification"; -- should create
SELECT * FROM "user"; --user 2 should have more 20 reputation
...
INSERT INTO photo (id, path) VALUES (1, 'photo.png');
INSERT INTO "user" (email, "name", "password", reputation, bio, expert, banned, profile_photo) VALUES ('test', 'misterarnildo', '123', 1499, 'wanna be expert', FALSE, FALSE, 1);
INSERT INTO "user" (email, "name", "password", reputation, bio, expert, banned, profile_photo) VALUES ('mail', 'user', '123', 1400, 'im goin down', FALSE, FALSE, 1);
INSERT INTO "user" (email, "name", "password", reputation, bio, expert, banned, profile_photo) VALUES ('another_mail', 'wuu', '123', 2000, 'im goin down', TRUE, FALSE, 1);
INSERT INTO moderator ("user_id") VALUES (2);
INSERT INTO tag ("name", "description", author_id) VALUES ('tagtest', 'description', 2);
INSERT INTO tag ("name", "description", author_id) VALUES ('expert tag', 'expert description', 3);
INSERT INTO tag ("name", "description", author_id) VALUES ('fail', 'fail description', 1); --should raise exception