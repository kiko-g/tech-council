    ...
    <div class="container-fluid justify-content-center px-3">
      ...
      <div class="collapse navbar-collapse border-left-0" id="navbarNav">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-black">
          <li class="nav-item">
            <a class="nav-link hover-cute btn btn-outline-light btn-sm border-0" href="/pages/moderator.php"><i class="fas fa-briefcase fa-sm"></i>&nbsp;Moderator</a>
          </li>
          <li class="nav-item">
            <a href="/pages/login.php" class="nav-link hover-cute btn btn-outline-light btn-sm border-0" type="submit"><i class="fas fa-sign-in-alt fa-sm"></i>&nbsp;Login</a>
          </li>
          <li class="nav-item">
            <a href="/pages/register.php" class="nav-link hover-cute btn btn-outline-light btn-sm border-0" type="submit"><i class="fas fa-user-plus fa-sm"></i>&nbsp;Register</a>
          </li>
          <li class="nav-item">
            <a href="/pages/register.php" class="nav-link hover-cute btn btn-outline-light btn-sm border-0" type="submit"><i class="fas fa-sign-out-alt fa-sm"></i>&nbsp;Logout</a>
          </li>
