              ...
              <div class="row row-cols-auto mb-3">
                <div id="tags" class="col-sm-auto">
                  ...
                  <div class="tag-selected btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-minus-square"></i>&nbsp;java</a>
                  </div>
                  <div class="tag-selected btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-minus-square"></i>&nbsp;node</a>
                  </div>
                  <div class="tag-selected btn-group mt-1">
                    <a" class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-minus-square"></i>&nbsp;msi</a>
                  </div>
                  <div class="tag-selected btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-minus-square"></i>&nbsp;nvidia</a>
                  </div>
                </div>
              ...
              <div class="card-body">
                ...
                <div id="tags" class="col-sm-auto">
                  <div class="search-tag btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-plus-square"></i>&nbsp;unix</a>
                  </div>
                  <div class="search-tag btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-plus-square"></i>&nbsp;ps4</a>
                  </div>
                  <div class="search-tag btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-plus-square"></i>&nbsp;dell</a>
                  </div>
                  <div class="search-tag btn-group mt-1">
                    <a class="btn btn-secondary border-0 my-btn-pad2"><i class="fas fa-plus-square"></i>&nbsp;apple</a>
                  </div>
                </div>
              </div>
            </div>
